  ...
  let s:guishade0 = "#30393a"
  let s:guishade1 = "#4e5450"
  let s:guishade2 = "#6b6e65"
  let s:guishade3 = "#89897b"
  let s:guishade4 = "#a6a491"
  let s:guishade5 = "#c4bfa7"
  let s:guishade6 = "#e1d9bc"
  let s:guishade7 = "#fff4d2"
  let s:guiaccent0 = "#c92e29"
  let s:guiaccent1 = "#e4e045"
  let s:guiaccent2 = "#dc9647"
  let s:guiaccent3 = "#63bb4d"
  let s:guiaccent4 = "#efbe8d"
  let s:guiaccent5 = "#21edd9"
  let s:guiaccent6 = "#ffe188"
  let s:guiaccent7 = "#f37aad"
